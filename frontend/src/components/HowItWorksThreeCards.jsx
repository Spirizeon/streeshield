...
const HowItWorksThreeCards = () => {
    return (
        <div className='HowItWorksThreeCards'>
            <div className='spotlight-card-outer HowItsWoksEachCardOuter'>
            ...
            <div className='spotlight-card-outer HowItsWoksEachCardOuter CardThreeInHowItWorks'>
                <div className='border-gradient-color'></div>
                <p className='CardNumber'>3</p>
                <SpotlightCard className="custom-spotlight-card cards-in-how-it-works CardThreeInHowItWorksInner" spotlightColor="rgba(0, 229, 255, 0.2)">
                    <img src={result} alt="" />
                    <div className='HowItWorksCardText'>
                        <h3>RESULT</h3>
